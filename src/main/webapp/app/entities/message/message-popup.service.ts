            ...
            if (id) {
                this.messageService.find(id)
                    .subscribe((messageResponse: HttpResponse<Message>) => {
                        ...
                        message.messageValidFrom = this.datePipe
                            .transform(message.messageValidFrom, 'yyyy-MM-ddTHH:mm:ss');
                        message.messageValidUntil = this.datePipe
                            .transform(message.messageValidUntil, 'yyyy-MM-ddTHH:mm:ss');
