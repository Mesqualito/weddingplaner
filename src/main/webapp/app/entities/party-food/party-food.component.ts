...
export class PartyFoodComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.partyFoodService
                ...
                .subscribe(
                    (res: HttpResponse<IPartyFood[]>) => this.paginatePartyFoods(res.body, res.headers),
    ...
    trackId(index: number, item: IPartyFood) {
        return item.id;
    }
    ...
    private paginatePartyFoods(data: IPartyFood[], headers: HttpHeaders) {
