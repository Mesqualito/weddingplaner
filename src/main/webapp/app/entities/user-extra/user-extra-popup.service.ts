            ...
            if (id) {
                this.userExtraService.find(id)
                    .subscribe((userExtraResponse: HttpResponse<UserExtra>) => {
                        ...
                        if (userExtra.guestInvitationDate) {
                            userExtra.guestInvitationDate = {
                                year: userExtra.guestInvitationDate.getFullYear(),
                                month: userExtra.guestInvitationDate.getMonth() + 1,
                                day: userExtra.guestInvitationDate.getDate()
                            };
                        }
